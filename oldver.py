...
def rockpaperscissors():
    ...
    if playerrps==computerrps:
        ...
        print(f"\nyou chose {playerrps}, which beats {computerrps}, you won!")
        ...
        print(f"\nyou chose {playerrps}, which is absolutely and utterly inferior to {computerrps}, you lost, loser!")
    else :
        print("\nthe computer got mad because you didn't input a proper action, you lost.")
...
def turtl():
    ...
    turt.speed(int(input("pick a number from 1 to 10 for the speed, use 0 for the fastest speed. : ")))
...
while True:
    chosengame=input("\nwelcome. pick between numguess and rockpaperscissors and rand16int and strand and turtle. \nuse ng/rps/16/t : ")
    if chosengame=="rps":
        rockpaperscissors()
    elif chosengame=="16":
        rand16int()
